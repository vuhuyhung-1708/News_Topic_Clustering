...
# Thư mục lưu kết quả
OUTPUT_DIR = os.path.join(PROCESSED_DIR, 'main_clustered_results')
...
clean_csv_path = os.path.join(OUTPUT_DIR, f'kmeans_clusters_k{K_VALUE}.csv')
...
kmeans_model_path = os.path.join(OUTPUT_DIR, f'kmeans_model_k{K_VALUE}.pkl')
